...
<head>
    ...
    <!-- Seo Meta Tags -->
    <title><?php echo $name; ?> Wishing you a Happy New year 2024</title>
    <meta name="description" content="<?php echo $name; ?> Wishing you a Happy New Year - Here is your Happy New Year 2024 Greeting Wishes." />
    <link rel="shortcut icon" href="https://cdn.jsdelivr.net/gh/mskian/happy-New-year-Wishing-web-app@master/favicon.png" type="image/png" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="<?php echo $name; ?> Wishing you a Happy New year 2024" />
    <meta name="twitter:description" content="<?php echo $name; ?> Wishing you a Happy New Year - Here is your Happy New Year 2024 Greeting Wishes." />
    ...
    <meta property="og:title" content="<?php echo $name; ?> Wishing you a Happy New year 2024" />
    ...
    <meta property="og:description" content="<?php echo $name; ?> Wishing you a Happy New Year - Here is your Happy New Year 2024 Greeting Wishes." />
    ...
    <!-- Google+ Meta Tags. -->
    <meta itemprop="name" content="<?php echo $name; ?> Wishing you a Happy New year 2024">
    <meta itemprop="description" content="<?php echo $name; ?> Wishing you a Happy New Year - Here is your Happy New Year 2024 Greeting Wishes.">
    <meta itemprop="image" content="OG THUMBNAIL URL">

    <link rel="stylesheet" type="text/css" href="/cdn/build/css/bootstrap.min.css" />
    ...
    <style>
        body {
            background-image: url("/cdn/build/image/bg.gif");
...
<body>
                ...
                <div class="col-lg-6 col-lg-offset-3 text-center">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading panel-heading-custom">
                            <h4 class="phead section-heading"><b>Wishes From - <?php echo $name; ?></b></h4>
                        </div>
                        <div class="panel-body veer-panel">
                            <h2 class="hello-head">Happy New Year</h2>
                            <div class="text-center">
                                <br />
                                <img class="animated infinite tada" src="/cdn/build/image/2024-2.png" width="300" alt="Happy New Year">
                            </div>
                            <br />
                            <br />
                            <p class="post-title text-center">Lets celebrate this blissful,<br />
                                cheerful, colorful New year. with a smile.<br />
                                <b>Wish you Happy new year.</b>
                            </p>
                            <h3 class="animated infinite pulse text-center"><b><i class="fa fa-star" aria-hidden="true"></i> <?php echo $name; ?> <i class="fa fa-star" aria-hidden="true"></i></b></h3><br />
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <div class="sharebuttons btn-group btn-group-lg">
                            <a class="btn btn-whatsapp" href="whatsapp://send?text=<?php echo rawurlencode($name); ?>%20💯%20Sending%20you%20a%20Happy%20New%20Year%20Greetings%20🎁%20👉%20<?php echo $current_page; ?>" target="_blank"><i class="fa fa-whatsapp"></i> <span>Share</span></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3 text-center">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <p><b>Happy Newe Year</b> - wish your loved ones a pleasant Happy New Year Wishes wishes in 2024 with our attractive greeting and a Specially Designed Web page.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="home-footer text-center">
        <p class="lnf footer-text">Copyright &copy; 2024 Happy New year Wishes.</p>
    </footer>

    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>
    <script src="/cdn/build/js/bootstrap.min.js"></script>
